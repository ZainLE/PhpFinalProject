...
class BookingController extends Controller
{
    ...
    {
        // Making sure that can can only see their own booking
    ...
    {
        // Making sure that can can only edit your own booking
        ...
        // Getting all the booking for the serive on that day
    ...
    {
        // Checing if you own the booking
        if ($booking->user_id !== auth()->id()) {
            abort(403);
        }
    ...
    private function getAvailableTimeSlots(Service $service)
    {
        ...
        while ($start <= $end) {
            ...
            for ($hour = 9; $hour < 17; $hour++) {
                ...
                // Checking if slot isnt booked already
