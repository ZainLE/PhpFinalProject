<x-layouts.site>
    ...
    <div class="container mx-auto px-4 py-12">
        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
            ...
            @empty
                <div class="col-span-full text-center py-12">
                    ...
                    <p class="text-gray-600">Be the first to offer a service in {{ $category }}</p>
                    <a href="{{ route('services.create') }}"
                       class="inline-block bg-indigo-600 text-white px-6 py-3 rounded-lg hover:bg-indigo-700 mt-4">
                        Create Service
                    </a>
                </div>
            @endforelse
        ...
        <!-- Pagination -->
        <div class="mt-12 bg-white p-4 rounded-lg">
            {{ $services->links() }}
        </div>
    </div>
</x-layouts.site>
